...
// This MUST match the data set in your FastAPI login endpoint [cite: gepetointraining/cer-sevn-app/cer-sevn-app-14252c908971bf8d7c7f9bf7b1d34d38e99522a7/apps/api/auth/login.py]
...
export async function getUserSession() {
  ...
  try {
    ...
    const organization = await prisma.organization.findUnique({
      ...
      select: { id: true, sectors: { where: { key: payload.sector } } },
    });
